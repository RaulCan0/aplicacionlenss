...
import 'package:aplicacionlensys/evaluacion/screens/empresas.dart';
import 'package:aplicacionlensys/home/perfil_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: NavigationBar(
        ...
        indicatorColor: Coloresapp.lensys.withOpacity(0.15),
        elevation: 3,
        ...
        destinations: const [
          NavigationDestination(
            ...
            selectedIcon: Icon(Icons.home_rounded, color: Coloresapp.lensys),
            label: 'Inicio',
          ),
          NavigationDestination(
            icon: Icon(Icons.person_outline, color: Colors.grey),
            selectedIcon: Icon(Icons.person, color: Coloresapp.lensys),
            label: 'Perfil',
          ),
          NavigationDestination(
                ...
                Row(
                  children: [
                    IconButton(
                      ...
                      onPressed: () {
                        _mostrarDialogoActualizacion(context);
                      },
                    ),
        ...
        child: Column(
          ...
          children: [
            if (title == 'Diagnóstico')
              ...
              Icon(icon, size: 50, color: Coloresapp.lensys),
            const SizedBox(height: 20),
            Text(
              title,
...
// ---------------------------------------------
// ACTUALIZACIONES DIALOG
// ---------------------------------------------

void _mostrarDialogoActualizacion(BuildContext context) {
  showDialog(
    context: context,
    builder: (context) => AlertDialog(
      title: const Text('Actualizaciones'),
      content: const Text('No hay actualizaciones disponibles en este momento.'),
      actions: [
        TextButton(
